<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (isset($_POST['edit_user_profile'])) {
            ...
            $user->v_password = ($_POST['password'] == $_POST['old_password']) ? $_POST['old_password'] : md5($_POST['password']);
                                    ...
                                    <div class="col-lg-9">
                                        <form role="form" method="POST" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="password" value="<?php echo $row['v_password']; ?>" placeholder="Enter username">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" id="summernote_profile" name="about" rows="3"><?php echo html_entity_decode($row['v_message']); ?></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary" name="edit_user_profile">Update Profile</button>
