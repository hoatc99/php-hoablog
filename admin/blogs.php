                                            ...
                                            <table class="table table-striped table-bordered table-hover" id="dataTables">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-success popup-button">View</button>
                                                            <button type="button" class="btn btn-warning" onclick="location.href='edit_blog.php?id=<?php echo $rows['n_blog_post_id']; ?>'">Edit</button>
                                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-blog<?php echo $rows['n_blog_post_id']; ?>">Drop</button>
