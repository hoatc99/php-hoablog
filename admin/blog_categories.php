                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#edit-category<?php echo $rows['n_category_id']; ?>">Edit</button>
                                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#delete-category<?php echo $rows['n_category_id']; ?>">Drop</button>
